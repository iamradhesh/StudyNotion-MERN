        ...
        <div className=' relative mx-auto flex flex-col w-11/12 items-center text-white justify-between max-w-maxContent'>
            ...
            <Link to={"/signup"}>
                ...
                <div className=' group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200
                    ...
                    <div className='shadow-richblack-400 shadow-sm flex flex-row items-center gap-2 rounded-full px-10 py-[5px] transition-all duration-200 group-hover:bg-richblack-900'>
            ...
            <div className='text-center text-4xl font-semibold mt-7'>
                Empower Your Future With {/*you can use this:- <span>Coding Skills</span> Or uncommented code*/}
            ...
            <div>
                ...
                backgroundGradient={"bg-gradient-radial from-richblack-800 to-amber-200 h-screen  "}
                />
            </div>
       ...
       {/*Section -2*/}
                ...
                <div className='bg-pure-greys-5 text-richblack-700'>
                    ...
                    <div className='  mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                            ...
                            <div className='ml-12 flex flex-row gap-5 mb-10 mt-[95px]'>
