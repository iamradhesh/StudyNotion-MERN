...
const VideoDetails = () => {
        ...
        if (!courseId || !sectionId || !subSectionId) {
          ...
          if (filteredData.length > 0 && filteredData[0].subSection) {
            ...
            if (filteredVideoData.length > 0) {
              ...
              // Handle case where subSectionId doesn't match any subSection
              // You might want to redirect or show an error message
              console.error("Subsection not found for subSectionId:", subSectionId);
            }
          } else {
            // Handle case where there are no subSections in the filtered data
            // You might want to redirect or show an error message
  ...
  const goToNextVideo = () => {
    ...
    if (currentSubSectionIndex !== noOfSubSections - 1) {
      ...
      // Handle case where this is the last video in the last section
